<template>
    ...
    <div class="bg-secondary h-screen">
                ...
                <div class="relative w-full">
                    <div class="min-w-full">
                        <div class="relative">
                            ...
                            <div
                                v-if="displayColors"
                                class="z-50 flex flex-col items-center space-y-2 py-2 absolute top-16 right-0 mr-4 h-auto w-12 bg-white bg-opacity-80 rounded-b-3xl"
                            >
                                <div
        ...
        <div id="parentDiv" class="max-w-screen-xl mx-auto">
            <div
                id="navbar"
                class="overflow-hidden flex items-center justify-evenly text-xl text-white uppercase font-semibold shadow-2xl bg-secondary rounded-md z-50"
                :class="`w-[${width}px]`"
            >
                <h1
            ...
            <UserReviews
                :bike="bike"
                :reviews="reviews"
                @remove-nav="removeNav"
                @slide-login="openSlideLogin"
                :url="`${url}`"
                :rates="rates"
            />
        </div>
