<template>
    ...
    >
        ...
        >
            ...
            <ul
                class="order-last lg:order-none flex items-center space-x-8 lg:flex"
            >
            ...
            >
                <input
                    class="w-full hidden lg:block bg-transparent border-b-2 border-t-0 border-l-0 border-r-0 border-gray-100 py-3 px-2 text-white outline-none focus:outline-none active:outline-none focus:ring-gray-100 active:ring-gray-100"
            ...
            <div class="relative flex items-center xl:justify-between">
                ...
                <ul class="items-center hidden space-x-8 lg:flex">
                    <li
                        ...
                        class="flex border-l-4 items-center justify-center h-12 px-1 xl:px-6 font-bold uppercase tracking-wide text-white transition duration-200 bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none cursor-pointer"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                <ul class="space-y-4">
                                    <li>
                                        <a
                                            ...
                                            aria-label="News"
                                            title="News"
                                            class="font-medium uppercase space-x-4 tracking-wide flex text-gray-100 transition-colors duration-200 hover:text-deep-purple-accent-400"
                                            >News
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            aria-label="Racing"
                                            title="Racing"
                                            class="text-sm font-bold uppercase space-x-4 flex items-center tracking-wide text-gray-100 transition-colors duration-200 hover:text-deep-purple-accent-400"
                                            >Racing
                                        </a>
                                    </li>
                                    <li>
