                        ...
                        <td class="px-6 py-4">
                          <div class="text-sm text-gray-900">
                            ...
                            >
                              ...
                              <span>{{ review.performance_rate }}</span>
                            </div>
                            <br />
                            <div
                              class="flex items-center justify-between w-full"
                            >
                              <p class="">Design & Styling:</p>
                              <span>{{ review.design_rate }}</span>
                            </div>
                            <br />
                          </div>
                        </td>
