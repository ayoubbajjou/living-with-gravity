            ...
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-indigo-600': style == 'success', 'bg-icon-button': style == 'danger' }">
                    ...
                    <div class="flex-shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-indigo-600 focus:bg-indigo-600': style == 'success', 'hover:bg-icon-button focus:bg-icon-button': style == 'danger' }"
                            aria-label="Dismiss"
